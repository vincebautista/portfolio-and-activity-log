...
export default function WorkError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    ...
    <main className="flex flex-1 flex-col items-center justify-center px-4 py-24 sm:px-6">
      <div className="flex max-w-md flex-col items-center gap-4 text-center">
        ...
        <h1 className="text-xl font-semibold text-foreground">
          Failed to load work gallery
        </h1>
        <p className="text-sm text-muted-foreground">
          Something went wrong while loading the project gallery. Please try
          again.
        </p>
